                ...
                <div class="row-fluid">
                    <form>
                        <div id="sample_1_length" class="dataTables_length">
                            ...
                            <label>学生名称: <input value="{{$params['name']}}" name="name" type="text" aria-controls="sample_1" class="m-wrap medium"> &nbsp;&nbsp;</label>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_1">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td><img style="widht:121px;height:121px;" src="{{qrcode id=$r['id'] role='student'}}" /></td>
                            <td>{{$r['phone']}}</td>
                            <td>{{$r['class_name']}}</td>
                            {{if $school_id == 0}}
                            <td>{{$r['school_name']}}</td>
                            ...
                            <td>
                                {{if $has_add_right['flg']}}
                                <a data-toggle="modal" data-target="#mod_1200" href="/student/add/id/{{$r['id']}}/"
                                    class="btn grey">
                                ...
                                <a data-link="/student/unenable/id/{{$r['id']}}/"
                                ...
                                <a data-link="/student/enable/id/{{$r['id']}}/"
