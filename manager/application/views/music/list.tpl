            ...
            <div class="clearfix">
                    {{if $has_add_right['flg']}}
                        <div class="btn-group pull-right">
                            <a data-toggle="modal" data-target="#mod_1200" href="/music/add/?curriculum_id={{$params['curriculum_id']}}" class="btn green" >
            ...
            <table class="table table-striped table-bordered table-hover" id="sample_1">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td>{{$r['t_name']}}</td>
                        <td>{{$r['name']}}</td>
                        <td><img src="{{$r['png_dir']}}" style="widht:60px; height: 60px;" /></td>
                        <td>{{$r['xml_name']}}</td>
                        <td>{{$r['mp3_name']}}</td>
                        ...
                        <td>
                                {{if $has_add_right['flg']}}
                                <a data-toggle="modal" data-target="#mod_1200" href="/music/add/id/{{$r['id']}}/?curriculum_id={{$r['curriculum_id']}}"
                                    class="btn grey">
                                ...
                                <a data-link="/music/unenable/id/{{$r['id']}}/"
                                ...
                                {{else}}
                                    ...
                                    <a data-link="/music/enable/id/{{$r['id']}}/"
