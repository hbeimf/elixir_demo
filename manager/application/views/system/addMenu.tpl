<form name="ff" id="ff" class="form-horizontal ajax_form" action="/system/addMenu" method='post'>
    ...
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
         <h4 class="modal-title">{{if isset($menu['id'])}}编辑{{else}}新增{{/if}}导航</h4>
    </div>
    <div class="modal-body">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                placeholder="请输入 Controller..." class="m-wrap span6" {{if isset($menu['id'])}}readonly{{/if}} />
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input value="{{if isset($menu['action'])}}{{$menu['action']}}{{/if}}"
                    ...
                    placeholder="请输入 Action..." class="m-wrap span6" {{if isset($menu['id'])}}readonly{{/if}} />
                <span class="help-inline"></span>
            </div>
        </div>
