            ...
            <div class="portlet-body">
                <div class="clearfix">
                    ...
                    <div class="btn-group pull-right">
                        <a data-toggle="modal" data-target="#mod_1200" href="/font/add/?curriculum_id={{$params['curriculum_id']}}" class="btn green" >
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_1">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>{{$r['id']}}</td>
                            <td title="{{$r['font']}}">{{sub_str str=$r['font']}}</td>
                            <td>{{$r['name']}}</td>
                            ...
                            <td>
                                {{if $has_add_right['flg']}}
                                <a data-toggle="modal" data-target="#mod_1200" href="/font/add/id/{{$r['id']}}/?curriculum_id={{$r['curriculum_id']}}"
                                    class="btn grey">
                                ...
                                <a data-link="/font/unenable/id/{{$r['id']}}/"
                                ...
                                <a data-link="/font/enable/id/{{$r['id']}}/"
