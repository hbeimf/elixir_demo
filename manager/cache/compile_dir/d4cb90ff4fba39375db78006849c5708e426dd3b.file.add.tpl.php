<?php /* Smarty version Smarty-3.1.8, created on 2018-03-28 19:51:28
         compiled from "/web/m.demo.com/application/views/curriculum/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17902524215a654317a356e9-01833064%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd4cb90ff4fba39375db78006849c5708e426dd3b' => 
    array (
      0 => '/web/m.demo.com/application/views/curriculum/add.tpl',
      1 => 1522215608,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17902524215a654317a356e9-01833064',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5a654317aadbd9_96713850',
  'variables' => 
  array (
    'curriculum_id' => 0,
    'role' => 0,
...
<?php if ($_valid && !is_callable('content_5a654317aadbd9_96713850')) {function content_5a654317aadbd9_96713850($_smarty_tpl) {?><form name="ff" id="ff" class="form-horizontal ajax_form" action="/curriculum/addstep/?curriculum_id=<?php echo $_smarty_tpl->tpl_vars['curriculum_id']->value;?>
...
<div id="div_select_ppt" class="control-group" style="display: none;">
    ...
    <div class="controls" style="padding-left: 25px;">
        	<a data-toggle="modal" data-target="#mod_900" href="/curriculum/ppt/" class="btn black" >选择PPT</a>
    </div>
</div>
...
<div id="div_select_music" class="control-group" style="display: none;">
    ...
    <div class="controls" style="padding-left: 25px;">
        	<a data-toggle="modal" data-target="#mod_900" href="/curriculum/music/" class="btn black" >选择乐谱</a>
    </div>
