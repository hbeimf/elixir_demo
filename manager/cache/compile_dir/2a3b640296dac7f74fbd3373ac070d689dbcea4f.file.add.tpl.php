<?php /* Smarty version Smarty-3.1.8, created on 2018-03-21 17:38:00
         compiled from "/web/m.demo.com/application/views/ppt/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17308150225a5c52c3915660-15043551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a3b640296dac7f74fbd3373ac070d689dbcea4f' => 
    array (
      0 => '/web/m.demo.com/application/views/ppt/add.tpl',
      1 => 1521625076,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17308150225a5c52c3915660-15043551',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5a5c52c3961731_05327821',
  'variables' => 
  array (
    'role' => 0,
    'area11' => 0,
...
<?php if ($_valid && !is_callable('content_5a5c52c3961731_05327821')) {function content_5a5c52c3961731_05327821($_smarty_tpl) {?><form name="ff" id="ff" class="form-horizontal ajax_form" action="/ppt/add" method='post' enctype="multipart/form-data">
        ...
        <tr>
            <td style="border: black solid 1px;">
                    <div style="height: 200px; padding-top: 5px;">
                        ...
                        <div class="controls">
                            <a data-toggle="modal" data-target="#mod_900" href="/ppt/pic/?area=11" class="btn green" > 
                            选择图片
                            </a>
                            <br />
        ...
        <tr>
            <td style="border-left: black solid 1px;border-right: black solid 1px;border-bottom: black solid 1px;">
                <div style="height: 200px; padding-top: 5px;">
                    ...
                    <div class="controls">
                        <a data-toggle="modal" data-target="#mod_900" href="/ppt/font/?area=12" class="btn green" >
                        选择文字音频
                        </a>
                        <br />
    ...
    <table style="width: 100%;">
        <tr>
            <td style="border: black solid 1px; width: 50%;">
                    ...
                    <label class="control-label" style="">提示：此处添加文字音频</label>
                    <div class="controls">
                        <a data-toggle="modal" data-target="#mod_900" href="/ppt/font/?area=21" class="btn green" >
                        选择文字音频
                        </a>
                        <br />
            ...
            <td style="border-right: black solid 1px;border-bottom: black solid 1px;border-top: black solid 1px;">
                    <div style="height: 200px; padding-top: 5px;">
                        <label class="control-label" style="">提示：此部分添加图片</label>
                        <div class="controls">
                            <a data-toggle="modal" data-target="#mod_900" href="/ppt/pic/?area=22" class="btn green" >
                            选择图片
                            </a>
                            <br />
        ...
        <tr>
           <td style="border-left: black solid 1px;border-bottom: black solid 1px;border-right: black solid 1px;">
                   <div style="height: 200px; padding-top: 5px;">
                    <label class="control-label" style="">提示：此处添加文字音频</label>
                    <div class="controls">
                        <a data-toggle="modal" data-target="#mod_900" href="/ppt/font/?area=23" class="btn green" >
                        选择文字音频
                        </a>
                        <br />
           ...
           <td style="border-bottom: black solid 1px;border-right: black solid 1px;">
                    ...
                    <label class="control-label" style="">提示：此处添加文字音频</label>
                    <div class="controls">
                        <a data-toggle="modal" data-target="#mod_900" href="/ppt/font/?area=24" class="btn green" >
                        选择文字音频
                        </a>
                        <br />
