<?php /* Smarty version Smarty-3.1.8, created on 2018-04-03 14:20:49
         compiled from "/mnt/web/m.demo.com/application/views/classes/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9216935535ac31d41123d79-72111813%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3cb5a04d4d4294b6a621808ae61acc6e8391dc6' => 
    array (
      0 => '/mnt/web/m.demo.com/application/views/classes/add.tpl',
      1 => 1522641537,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9216935535ac31d41123d79-72111813',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac31d41158810_37287237',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac31d41158810_37287237')) {function content_5ac31d41158810_37287237($_smarty_tpl) {?><form name="ff" id="ff" class="form-horizontal ajax_form" action="/classes/add" method='post' enctype="multipart/form-data">
...
<?php }?>" />
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
         <h4 class="modal-title"><?php if (isset($_smarty_tpl->tpl_vars['role']->value['id'])){?>编辑<?php }else{ ?>新增<?php }?>班级</h4>
    </div>
...
<input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['school_id']->value;?>
" name="school_id" />
<?php }else{ ?>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <input value="<?php if (isset($_smarty_tpl->tpl_vars['role']->value['desc'])){?><?php echo $_smarty_tpl->tpl_vars['role']->value['desc'];?>
<?php }?>"
