<?php /* Smarty version Smarty-3.1.8, created on 2018-04-23 10:00:07
         compiled from "/erlang/elixir_demo/manager/application/views/ppt/list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18777902335add3e279d80a0-54497853%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2b73800feb59bd0c4d4d4bb90bb7d5c222802976' => 
    array (
      0 => '/erlang/elixir_demo/manager/application/views/ppt/list.tpl',
      1 => 1524212142,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18777902335add3e279d80a0-54497853',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5add3e27a3a751_58885117',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5add3e27a3a751_58885117')) {function content_5add3e27a3a751_58885117($_smarty_tpl) {?><?php if ($_smarty_tpl->tpl_vars['params']->value['curriculum_id']!=''){?>
        ...
        <div class="portlet-body">
            <div class="clearfix">
                ...
                <div class="btn-group pull-right">
                    <a data-toggle="modal" data-target="#mod_1200" href="/ppt/add/?curriculum_id=<?php echo $_smarty_tpl->tpl_vars['params']->value['curriculum_id'];?>
" class="btn green">
...
" /></td> -->
                        ...
                        <td><?php if ($_smarty_tpl->tpl_vars['r']->value['is_enabled']==1){?>启用<?php }else{ ?>
                            <font color=red>禁用</font><?php }?></td>
                        ...
                        <td>
                            <?php if ($_smarty_tpl->tpl_vars['has_add_right']->value['flg']){?>
                            <a data-toggle="modal" data-target="#mod_1200" href="/ppt/add/id/<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
/?curriculum_id=<?php echo $_smarty_tpl->tpl_vars['r']->value['curriculum_id'];?>
" class="btn grey">
                                    <i class="fa fa-pencil"></i>编辑
                                </a> <?php }?> <?php if ($_smarty_tpl->tpl_vars['r']->value['is_enabled']==1){?> <?php if ($_smarty_tpl->tpl_vars['has_unenable_right']->value['flg']){?>
                            <a data-link="/ppt/unenable/id/<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
/" class="btn red ajax-delete" data-msg="确认要禁用吗？">
                                    <i class="fa fa-pencil"></i>禁用
                                </a> <?php }?> <?php }else{ ?> <?php if ($_smarty_tpl->tpl_vars['has_enable_right']->value['flg']){?>
                            <a data-link="/ppt/enable/id/<?php echo $_smarty_tpl->tpl_vars['r']->value['id'];?>
