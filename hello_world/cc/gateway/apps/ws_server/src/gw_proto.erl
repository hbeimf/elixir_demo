...
dfp_read_field_def_GetEntranceRes(<<10, Rest/binary>>,
    ...
    d_field_GetEntranceRes_entrace_url(Rest, Z1, Z2, F1, F2,
				       F3, TrUserData);
dfp_read_field_def_GetEntranceRes(<<18, Rest/binary>>,
				  Z1, Z2, F1, F2, F3, TrUserData) ->
    d_field_GetEntranceRes_server_type(Rest, Z1, Z2, F1, F2,
				       F3, TrUserData);
dfp_read_field_def_GetEntranceRes(<<26, Rest/binary>>,
				  Z1, Z2, F1, F2, F3, TrUserData) ->
    d_field_GetEntranceRes_server_id(Rest, Z1, Z2, F1, F2,
				     F3, TrUserData);
dfp_read_field_def_GetEntranceRes(<<>>, 0, 0, F1, F2,
				  F3, _) ->
    #'GetEntranceRes'{entrace_url = F1, server_type = F2,
		      server_id = F3};
dfp_read_field_def_GetEntranceRes(Other, Z1, Z2, F1, F2,
				  F3, TrUserData) ->
    dg_read_field_def_GetEntranceRes(Other, Z1, Z2, F1, F2,
				     F3, TrUserData).
...
dg_read_field_def_GetEntranceRes(<<0:1, X:7,
    ...
    case Key of
      10 ->
	  d_field_GetEntranceRes_entrace_url(Rest, 0, 0, F1, F2,
					     F3, TrUserData);
      18 ->
	  d_field_GetEntranceRes_server_type(Rest, 0, 0, F1, F2,
					     F3, TrUserData);
      26 ->
	  d_field_GetEntranceRes_server_id(Rest, 0, 0, F1, F2, F3,
					   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_GetEntranceRes(Rest, 0, 0, F1, F2, F3,
					   TrUserData);
	    1 ->
		skip_64_GetEntranceRes(Rest, 0, 0, F1, F2, F3,
				       TrUserData);
	    2 ->
		skip_length_delimited_GetEntranceRes(Rest, 0, 0, F1, F2,
						     F3, TrUserData);
	    5 ->
		skip_32_GetEntranceRes(Rest, 0, 0, F1, F2, F3,
				       TrUserData)
	  end
    end;
dg_read_field_def_GetEntranceRes(<<>>, 0, 0, F1, F2, F3,
				 _) ->
    #'GetEntranceRes'{entrace_url = F1, server_type = F2,
		      server_id = F3}.
...
d_field_GetEntranceRes_server_id(<<0:1, X:7,
    ...
    <<Bytes:Len/binary, Rest2/binary>> = Rest,
    NewFValue = binary:copy(Bytes),
    dfp_read_field_def_GetEntranceRes(Rest2, 0, 0, F1, F2,
				      NewFValue, TrUserData).


skip_varint_GetEntranceRes(<<1:1, _:7, Rest/binary>>,
			   Z1, Z2, F1, F2, F3, TrUserData) ->
    skip_varint_GetEntranceRes(Rest, Z1, Z2, F1, F2, F3,
			       TrUserData);
skip_varint_GetEntranceRes(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, F1, F2, F3, TrUserData) ->
    dfp_read_field_def_GetEntranceRes(Rest, Z1, Z2, F1, F2,
				      F3, TrUserData).
...
dfp_read_field_def_VerifyRes(<<8, Rest/binary>>, Z1, Z2,
			     F1, F2, F3, TrUserData) ->
    d_field_VerifyRes_code(Rest, Z1, Z2, F1, F2, F3,
			   TrUserData);
dfp_read_field_def_VerifyRes(<<18, Rest/binary>>, Z1,
			     Z2, F1, F2, F3, TrUserData) ->
    d_field_VerifyRes_uid(Rest, Z1, Z2, F1, F2, F3,
			  TrUserData);
dfp_read_field_def_VerifyRes(<<26, Rest/binary>>, Z1,
			     Z2, F1, F2, F3, TrUserData) ->
    d_field_VerifyRes_msg(Rest, Z1, Z2, F1, F2, F3,
			  TrUserData);
dfp_read_field_def_VerifyRes(<<>>, 0, 0, F1, F2, F3,
			     _) ->
    #'VerifyRes'{code = F1, uid = F2, msg = F3};
...
dg_read_field_def_VerifyRes(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      8 ->
	  d_field_VerifyRes_code(Rest, 0, 0, F1, F2, F3,
				 TrUserData);
      18 ->
	  d_field_VerifyRes_uid(Rest, 0, 0, F1, F2, F3,
				TrUserData);
      26 ->
	  d_field_VerifyRes_msg(Rest, 0, 0, F1, F2, F3,
				TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_VerifyRes(Rest, 0, 0, F1, F2, F3,
				      TrUserData);
	    1 ->
		skip_64_VerifyRes(Rest, 0, 0, F1, F2, F3, TrUserData);
	    2 ->
		skip_length_delimited_VerifyRes(Rest, 0, 0, F1, F2, F3,
						TrUserData);
	    5 ->
		skip_32_VerifyRes(Rest, 0, 0, F1, F2, F3, TrUserData)
	  end
    end;
dg_read_field_def_VerifyRes(<<>>, 0, 0, F1, F2, F3,
			    _) ->
    #'VerifyRes'{code = F1, uid = F2, msg = F3}.
...
d_field_VerifyRes_msg(<<1:1, X:7, Rest/binary>>, N, Acc,
		      F1, F2, F3, TrUserData)
    when N < 57 ->
    d_field_VerifyRes_msg(Rest, N + 7, X bsl N + Acc, F1,
			  F2, F3, TrUserData);
...
skip_varint_VerifyRes(<<1:1, _:7, Rest/binary>>, Z1, Z2,
		      F1, F2, F3, TrUserData) ->
    skip_varint_VerifyRes(Rest, Z1, Z2, F1, F2, F3,
			  TrUserData);
